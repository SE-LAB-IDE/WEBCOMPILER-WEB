	...
	<div id="page-wrapper">
					...
					<li class="special"><a href="#menu" class="menuToggle"><span>Menu</span></a>
						<div id="menu">
							<ul>
								...
								%>
								<li><a href="algorithm/addAlgorithm.jsp">알고리즘 추가</a></li>
		...
		<section id="banner">
			<div class="inner">
				...
				<ul class="actions special">
					<li><a href="ide/IDE.jsp" target="_blank" class="button primary">Go
							WorkSpace</a></li>
				</ul>
			</div>
		...
		<section id="two" class="wrapper alt style2">
			<section class="spotlight">
				<div class="image">
					<img src="./css/images/pic01.jpg" alt="" />
				</div>
				<div class="content">
					<h2>SE LAB</h2>
					<p>
						이 사이트는 SE LAB 홈페이지의 <br /> 부가적인 기능이다.<br /> 홈페이지에서는 SE LAB의 다양한
						<br />정보 및 자유로운 환경을 제공한다.<br /> 여러 게시판들을 이용하여<br /> SE내의 다양한
						정보를 제공한다
					</p>
				</div>
			</section>
			<section class="spotlight">
				<div class="image">
					<img src="./css/images/pic02.jpg" alt="" />
				</div>
				<div class="content">
			...
			<section class="spotlight">
				<div class="image">
					<img src="./css/images/pic03.jpg" alt="" />
				</div>
				<div class="content">
					<h2>BulletinBoard</h2>
					<p>
		...
		<section id="cta" class="wrapper style4">
			<div class="inner">
               ...
               <%
                        if (session.getAttribute("id") == null) {
                        %>
               <li><a href="../join/join.jsp" class="button fit primary">SE_JOIN</a></li>
               <%} else{ %>
               <li><a href="ide/IDE.jsp" target="_blank" class="button fit primary">SE IDE</a></li>
               <%} 
                        if (session.getAttribute("id") == null) {
                        %>
               <li><a href="LoginFormServlet" class="button fit">SE_LOGIN</a></li>
               <%} else{ %>
               <li><a href="" class="button fit" onclick="logOut()">SE_LOGOUT</a></li>
               <%} %>
            </ul>
			</div>
		</section>
