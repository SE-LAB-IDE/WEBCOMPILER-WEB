...
@WebServlet("/shellCompile_ide")
public class shelllCompile_ide extends HttpServlet {
	            ...
	            if (codeType.equals("c")) {
	               ...
	               for (int i = 0; i < output.length; i++) {
	                  ...
	                  try {
	                     ...
	                     out.print("<strong>[" + (i + 1) + "번]</strong>       <strong>[실행시간]</strong>"
	                     ...
	                     out.print("<strong>[" + (i + 1) + "번          "
	                           + Reader("/usr/local/apache/share/timeCheck.txt") + "    <strong>[실행 X]</strong>");
