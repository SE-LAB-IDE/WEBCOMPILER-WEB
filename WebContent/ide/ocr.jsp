...
<body>
   ...
   if(request.getAttribute("ocrCode")!=null) // ocrCode가 있는지 확인
   {
      ...
      <form action="./ide/editor.jsp" target="editor" method="post">
         <input type="hidden" name="ocr" value="1"> 
         <input type="hidden" name="tmp" value='<%=ocrCode%>'> 
   ...
   while (iter.hasNext()) {
      ...
      File uploadfile = new File("/usr/local/apache/" + fileName);// 파일 저장 경로
...
window.onload = function () {
    ...
    form.setAttribute("action", "../ocrCompile"); //요청 보낼 주소
