...
.box1{
	 margin-top:6px;margin-left:4%;z-index: 2;width: 20%;height: 30px; background-color: #e8c7ac;
}
.box2{
	padding-left:20px; padding-top:5px; padding-bottom:5px; margin-top:-22px; margin-left:10%;z-index: 3;width: 78%;height: 25px; background-color: #efefef; color:#000000;
}
...
<body>
	...
	%>
	<div class=box1></div>
		<div class=box2><div class="listTitle" onclick="showOrHide(codeListC)">C</div>
	</div>
	...
	<hr>
	<div class=box1></div>
		<div class=box2><div class="listTitle" onclick="showOrHide(codeListJava)">java</div>
	</div>
	...
	<hr>
	<div class=box1></div>
		<div class=box2><div class="listTitle" onclick="showOrHide(codeListPython)">python</div>
	</div>
	...
	<hr>
	<div class=box1></div>
		<div class=box2><div class="listTitle" onclick="showOrHide(codeListJavascript)">javaScript</div>
	</div>
