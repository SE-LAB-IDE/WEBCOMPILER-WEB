...
public class mailSender {
	...
	public static boolean sendMail(memberVO vo) {
		...
		String fromEmail = "selab0x00@gamil.com";// 보내는 주소
		String fromUsername = "SE HomePage Manager";// 보내는이 이릅
		String toEmail = vo.getMail(); // 받는 주소

		final String username = "selab0x00@gmail.com"; // gmail id
		final String password = "Qlalfqjsgh!"; // gmail pw

		// 메일에 출력할 텍스트
		String url = "http://192.168.23.144:8080/findIdPw/changePwForm.jsp";
